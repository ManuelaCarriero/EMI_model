...
%     medians_fsup=medians_dwi;
% elseif strcmp(micro_parameter,'fc')
%     medians_fc=medians_dwi;
% elseif strcmp(micro_parameter,'Rsoma')
%     medians_rsoma=medians_dwi;
% end
...
patch(x_all,y_all,'cyan','FaceAlpha',0.05,'EdgeColor','none')

hold on
plot(x_sorted,y_fit_sorted,'--','LineWidth',3,'Color',"#000000");
hold on
plot(x_sorted,y_fit_sorted-delta_sorted,'--',x_sorted,y_fit_sorted+delta_sorted,'--','LineWidth',0.1,'Color',"#000000")
...
% %% if you don't want to account for multiple testing correction 
% %(only pvalue < 0.05)
% 
% idx_nans=find(isnan(z));
% z_accepted=z;
% z_accepted(idx_nans)=[];
% 
% labels_final_accepted = labels_final;
% labels_final_accepted(idx_nans)=[];
% 
% idx_1=find(z_accepted==1);
% z_accepted(idx_1)=[];
% labels_final_accepted(idx_1)=[];

%% in case you want the uncorrected for BHFDR map
